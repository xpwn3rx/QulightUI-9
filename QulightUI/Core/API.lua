...
function T.SkinCloseButton(f, point, text, pixel)
	...
	if not f.text then
		if pixel then
			f.text = f:FontString(nil, [[Interface\AddOns\QulightUI\Media\Fonts\Pixel.ttf]], 8)
...
>>>>>>> 8069f02c1 ([Skins] Added EditModeManager and QuickKeybind skins.):QulightUI/Core/API.lua
=======
﻿local T, C, L, _ = unpack(select(2, ...))
...
>>>>>>> 64887a244 ([Skins] Added ProfessionsCustomerOrdersFrame and Profession spec and orders pages skin.):QulightUI/Core/API.lua
end)