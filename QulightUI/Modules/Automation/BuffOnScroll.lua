...
<<<<<<< HEAD:QulightUI/Modules/Automation/BuffOnScroll.lua
		print("|cffff0000QulightUI: BuffOnScroll spell ID ["..tostring(id).."] no longer exists!|r")
=======
		print("|cffff0000ShestakUI: BuffOnScroll spell ID ["..tostring(id).."] no longer exists!|r")
>>>>>>> 9c91beaff (Change debug message when spell id incorrect.):ShestakUI/Modules/Automation/BuffOnScroll.lua
		return "Empty"
	end
end
