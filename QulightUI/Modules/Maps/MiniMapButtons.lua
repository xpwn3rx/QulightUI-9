...
switch:SetScript("OnClick", function(_, button)
	...
	elseif button == "MiddleButton" then
		QulightUISettings.RaidLayout = "NONE"
		ReloadUI()
	end
end)
...
switch:SetScript("OnEvent", function()
	if QulightUISettings and QulightUISettings.RaidLayout == "DPS" then
		switch.t:SetTexCoord(0.25, 0.5, 0, 1)
	elseif QulightUISettings and QulightUISettings.RaidLayout == "HEAL" then
		switch.t:SetTexCoord(0.75, 1, 0, 1)
	elseif QulightUISettings and QulightUISettings.RaidLayout == "NONE" then
		switch.t:SetTexture("Interface\\ChatFrame\\UI-ChatIcon-Blizz")
		switch.t:SetTexCoord(0.2, 0.8, -0.1, 1.1)
	elseif QulightUISettings and QulightUISettings.RaidLayout == "UNKNOWN" or QulightUISettings == nil then
