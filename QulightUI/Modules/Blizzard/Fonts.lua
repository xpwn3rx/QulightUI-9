...
if LSM then
	LSM:Register(LSM.MediaType.FONT, "Calibri", [[Interface\AddOns\QulightUI\Media\Fonts\Normal.ttf]], LOCALE_MASK)
	LSM:Register(LSM.MediaType.FONT, "Hooge", [[Interface\AddOns\QulightUI\Media\Fonts\Pixel.ttf]], LOCALE_MASK)
	LSM:Register(LSM.MediaType.STATUSBAR, "Smooth!", [[Interface\AddOns\QulightUI\Media\Textures\Texture.tga]])
end