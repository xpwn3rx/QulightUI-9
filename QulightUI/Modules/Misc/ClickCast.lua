...
SpellBinder:SetScript("OnEvent", function(self, event)
	if event == "PLAYER_LOGIN" then
		QulightUIBindings = _G.QulightUIBindings or {}
		QulightUIBindings[UnitName("player")] = _G.QulightUIBindings[UnitName("player")] or {}
		DB = QulightUIBindings[UnitName("player")]
