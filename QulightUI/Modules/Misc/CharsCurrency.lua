...
frame:SetScript("OnEvent", function(self, event, addon)
	if event == "ADDON_LOADED" then
		if addon ~= "QulightUI" then return end

		if faction ~= "Alliance" and faction ~= "Horde" then return end

		QulightUICurrency = QulightUICurrency or {}
		QulightUICurrency[T.realm] = QulightUICurrency[T.realm] or {}
		QulightUICurrency[T.realm][faction] = QulightUICurrency[T.realm][faction] or {}
		QulightUICurrency[T.realm][faction][T.name] = QulightUICurrency[T.realm][faction][T.name] or {}

		realmDB = QulightUICurrency[T.realm][faction]
