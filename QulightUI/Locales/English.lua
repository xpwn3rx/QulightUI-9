...
<<<<<<< HEAD:QulightUI/Locales/English.lua
L_MISC_UI_OUTDATED = "Your version of QulightUI is out of date. You can download the latest version from https://www.wowinterface.com/downloads/info16324-QulightUI.html"
=======
>>>>>>> e413ff862 (Removed CheckVersion function.):ShestakUI/Locales/English.lua
...
-- Popups
L_POPUP_INSTALLUI = "First time on QulightUI with this Character. You must reload UI to configure it."
L_POPUP_RESETUI = "Are you sure you want to reset all settings for QulightUI?"
...
L_POPUP_DISABLEUI = "QulightUI doesn't work for this resolution, do you want to disable QulightUI? (Cancel if you want to try another resolution)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Welcome to QulightUI "
L_WELCOME_LINE_2_1 = "Type /cfg to config interface, or visit https://www.wowinterface.com/downloads/info16324-QulightUI.html"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Resets QulightUI_Config settings.",
