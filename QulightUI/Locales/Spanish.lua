...
-- Popups
L_POPUP_INSTALLUI = "Es la primera vez que usas QulightUI con este personaje. Usted debe volver a cargar la interfaz de usuario para configurarlo."
L_POPUP_RESETUI = "¿Estás seguro de que desea restablecer QulightUI?"
...
L_POPUP_DISABLEUI = "QulightUI no funciona con esta resolución, ¿Quieres desactivar QulightUI? (Pulsa cancelar si quieres probar otra resolución)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Bienvenido a QulightUI "
L_WELCOME_LINE_2_1 = "Escribe /cfg para configurar la interfaz, o visita https://www.wowinterface.com/downloads/info16324-QulightUI.html"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Reinicia la configuración de QulightUI_Config.",
