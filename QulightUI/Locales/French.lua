...
>>>>>>> 1957c7e2f (Cleanup.):ShestakUI/Locales/French.lua
...
-- Popups
L_POPUP_INSTALLUI = "Première utilisation de QulightUI avec ce personnage. Vous devez recharger l'interface utilisateur pour le configurer."
L_POPUP_RESETUI = "Etes-vous sûr de vouloir réinitialiser QulightUI ?"
...
L_POPUP_DISABLEUI = "QulightUI ne fonctionne pas avec cette résolution, voulez-vous désactiver QulightUI ? (Annuler si vous souhaitez essayer une autre résolution)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Bienvenue sur QulightUI "
L_WELCOME_LINE_2_1 = "Tapez /cfg pour configurer l'interface, ou visitez https://www.wowinterface.com/downloads/info16324-QulightUI.html"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Remet les paramètres QulightUI_Config à leurs valeurs par défaut.",
