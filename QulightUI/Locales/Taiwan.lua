...
L_MISC_UI_OUTDATED = "QulightUI 版本已過期，請至 https://www.wowinterface.com/downloads/info16324-QulightUI.html 下載最新版。"
=======
>>>>>>> e413ff862 (Removed CheckVersion function.):ShestakUI/Locales/Taiwan.lua
...
L_POPUP_DISABLEUI = "QulightUI不支援此解析度，是否停用QulightUI? (若要嘗試其他解析度請按取消)"
...
-- Welcome message
L_WELCOME_LINE_1 = "歡迎使用QulightUI "
L_WELCOME_LINE_2_1 = "鍵入 /cfg 進行UI設置, 或者訪問 https://www.wowinterface.com/downloads/info16324-QulightUI.html"
...
L_SLASHCMD_HELP = {
	...
	"/resetui - 重置一般設置到預設值",
	"/resetuf - 重置頭像框架到預設位置",
	"/resetconfig - 重置QulightUI_Config到預設值",
