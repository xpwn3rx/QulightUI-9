...
-- Popups
L_POPUP_INSTALLUI = "È la prima volta che utilizzi la QulightUI con questo personaggio. Devi riavviare l'interfaccia utente per configurarla."
L_POPUP_RESETUI = "Vuoi davvero ripristinare tutte le impostazioni iniziali della QulightUI?"
...
L_POPUP_DISABLEUI = "A questa risoluzione la QulightUI non funziona correttamente, vuoi disabilitare l'AddOn (clicca 'Cancella' se vuoi provare con un'altra risoluzione)?"
...
-- Welcome message
L_WELCOME_LINE_1 = "Benvenuto/a in QulightUI "
L_WELCOME_LINE_2_1 = "Digita /cfg per configurare l'interfaccia oppure visita https://www.wowinterface.com/downloads/info16324-QulightUI.html"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Riporta le impostazioni della QulightUI_Config a quelle iniziali.",
