...
-- Popups
L_POPUP_INSTALLUI = "Это первый запуск QulightUI для этого персонажа. Необходимо перезагрузить интерфейс для его настройки."
L_POPUP_RESETUI = "Вы уверены, что хотите сбросить настройки QulightUI?"
...
L_POPUP_DISABLEUI = "QulightUI не работает на этом разрешении, хотите отключить QulightUI? (Отмена, если хотите попробовать другое разрешение)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Добро пожаловать в QulightUI "
L_WELCOME_LINE_2_1 = "Введите /cfg для входа в настройки интерфейса, или посетите страницу https://www.wowinterface.com/downloads/info16324-QulightUI.html"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Сброс настроек QulightUI_Config.",
