...
C["position"] = {
	...
	["chat"] = {"BOTTOMLEFT", UIParent, "BOTTOMLEFT", 6, 23},						-- Chat
	...
	["tooltip"] = {"BOTTOMRIGHT", UIParent, "BOTTOMRIGHT", -4, 4},					-- Tooltip
	...
	["player_buffs"] = {"TOPRIGHT", UIParent, "TOPRIGHT", -(C.minimap.size + 8), -4},				-- Player buffs
