...
----------------------------------------------------------------------------------------
C["media"] = {
	["normal_font"] = [[Interface\AddOns\QulightUI\Media\Fonts\Normal.ttf]],		-- Normal font
	["blank_font"] = [[Interface\AddOns\QulightUI\Media\Fonts\Blank.ttf]],			-- Blank font
	["pixel_font"] = [[Interface\AddOns\QulightUI\Media\Fonts\Pixel.ttf]],			-- Pixel font
	["pixel_font_style"] = "OUTLINE",							-- Pixel font style ("OUTLINE" or "OUTLINE")
	["pixel_font_size"] = 15,								-- Pixel font size for those places where it is not specified
	["blank"] = [[Interface\AddOns\QulightUI\Media\Textures\White.tga]],			-- Texture for borders
	["texture"] = [[Interface\AddOns\QulightUI\Media\Textures\Texture.tga]],		-- Texture for status bars
	...
	["empty"] = [[Interface\AddOns\QulightUI\Media\Textures\Invisible.tga]],		-- Invisible texture
...
C["nameplate"] = {
	...
	["height"] = 13,							-- Nameplate height
	["width"] = 140,							-- Nameplate width
...
C["automation"] = {
	...
	["whisper_invite"] = true,					-- Auto invite when whisper keyword
	["invite_keyword"] = "inv + invite",		-- List of keyword (separated by space)
}
