...
L.raidframe_plugins_over_absorb = "框架显示过量吸收条"
L.raidframe_plugins_over_heal_absorb = "框架显示过量治疗吸收条"
...
L.nameplate_short_name = "用简称替换名字"
...
L.aura_subheader_buffs = "玩家buffs"
