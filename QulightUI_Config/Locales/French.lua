...
L_GUI_RESET_CHAR = "Êtes-vous sûr de vouloir réinitialiser les paramètres de votre personnage pour QulightUI ?"
L_GUI_RESET_ALL = "Voulez-vous vraiment réinitialiser tous les paramètres de QulightUI"
